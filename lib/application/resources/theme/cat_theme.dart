...
import "package:thecat_rodgav/application/resources/theme/cat_text_styles.dart";
...
class CatTheme {
  ...
  ThemeData theme(ColorScheme colorScheme) => ThemeData(
        ...
        textTheme: _primaryTextTheme.apply(
  ...
  static const _primaryTextTheme = TextTheme(
    displayMedium: CatTextStyles.displayMedium,
    displaySmall: CatTextStyles.displaySmall,
    headlineMedium: CatTextStyles.headlineMedium,
    headlineSmall: CatTextStyles.headlineSmall,
    titleMedium: CatTextStyles.titleMedium,
    titleSmall: CatTextStyles.titleSmall,
    bodyLarge: CatTextStyles.bodyLarge,
    bodyMedium: CatTextStyles.bodyMedium,
    bodySmall: CatTextStyles.bodySmall,
    labelMedium: CatTextStyles.labelMedium,
    labelSmall: CatTextStyles.labelSmall,
  );
}
