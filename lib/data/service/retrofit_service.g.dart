...
class _RetrofitService implements RetrofitService {
  ...
  @override
  Future<BreedResponse> getBreed(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<BreedResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late BreedResponse _value;
    try {
      _value = BreedResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
